      ...
      >
            ...
            {confirmationType === "reset" ? (
              <>
                ...
                <p className="text-sm">
                  ...
                  All affected customers will have their points balance set to
                  zero.
                </p>
              </>
            ) : (
        ...
        >
          <button
            onClick={onClose}
            disabled={loading}
            className="flex-1 px-3 py-2 rounded-lg transition-colors bg-muted text-gray-200 hover:bg-gray-600"
          >
            Cancel
          </button>
          <button
