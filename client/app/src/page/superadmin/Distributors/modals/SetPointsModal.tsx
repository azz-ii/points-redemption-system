              ...
              {showAdvanced && (
                ...
                >
                  ...
                  >
                    ...
                    >
                      This will apply the same adjustment to all {totalCount} distributor(s). Cannot be undone.
                    </p>
                  </div>
                  ...
                  <div className="mb-3">
                    <label className="flex items-start gap-2 cursor-pointer">
                      ...
                      >
                        I understand this will affect all {totalCount} distributor(s) and cannot be undone
                      </span>
                    </label>
                  </div>
