...
interface ViewAssignedItemModalProps extends ModalBaseProps {
  product: Product | null;
}

export function ViewAssignedItemModal({
  isOpen,
  onClose,
  product,
}: ViewAssignedItemModalProps) {
  ...
  return (
    <div className="fixed inset-0 flex items-center justify-center z-50 p-4 bg-black/30 backdrop-blur-sm">
      <div
        ...
        role="dialog"
        aria-modal="true"
        aria-labelledby="view-assigned-item-title"
      >
        <div className="flex justify-between items-center p-8">
          <div>
            <h2 id="view-assigned-item-title" className="text-xl font-semibold">
              View Product
            </h2>
          ...
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div>
                ...
                <span
                  className={`inline-block px-3 py-1 rounded-full text-xs font-semibold ${getLegendColor(product.legend)}`}
                >
