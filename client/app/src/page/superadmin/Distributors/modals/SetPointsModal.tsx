...
export function SetPointsModal({
  ...
  const handleSubmit = () => {
    const updates = distributors.map((distributor) => {
      ...
      const newPoints = (distributor.points || 0) + delta; // Allow negative values
      return {
        id: distributor.id,
        points: newPoints,
      };
                ...
                >
                  ...
                  >
                    ...
                    >
                      ...
                      {distributors.length} distributor(s). This action cannot
                      be undone.
                    </p>
                  </div>
                  ...
                  <div className="mb-4">
                    <label className="flex items-start gap-2 cursor-pointer">
                      ...
                      >
                        I understand this will affect all {distributors.length}{" "}
                  ...
                  {onResetAll && (
                    <>
                      ...
                      >
                        <AlertTriangle className="h-4 w-4" />
                        {loading ? "Resetting..." : `Reset All ${distributors.length} Distributors to 0 Points`}
                      </button>
                    </>
                  )}
                </div>
